...
class App extends Component {
  state = { loaded: false, cost: 0, itemName: "exemple_1" };
  ...
  handleSubmit = async() => {
    ...
    let result = this.itemManager.methods.createItem(itemName, cost).send({from: this.accounts[0]});
    console.log(result);
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>EventTrigger Supply Chain Example</h1>
         <h2>Items</h2>
          <h2>Add Items</h2>
